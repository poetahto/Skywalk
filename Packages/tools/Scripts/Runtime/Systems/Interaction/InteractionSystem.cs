...
public class InteractionSystem : MonoBehaviour
{
    ...
    [PublicAPI] public Ray ViewRay { get; set; }
    ...
    private void GrabObject(Interactable interactable, Vector3 point)
    {
        ...
        CurrentInteractable.InteractStart(lookDirection.gameObject, point);
    ...
    {
        bool lookingAtObject = Physics.Raycast(ViewRay, out RaycastHit hitInfo, float.PositiveInfinity, ~ignoredLayers.value, QueryTriggerInteraction.Ignore);
