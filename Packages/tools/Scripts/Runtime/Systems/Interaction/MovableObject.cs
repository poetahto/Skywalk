...
public class MovableObject : MonoBehaviour
{
    ...
    public Vector3 TargetPosition => Grabber.transform.position + Grabber.transform.forward * 1.5f;
    private Transform Grabber { get; set; }
    ...
    private void MoveTowardsTarget()
    {
        ...
        Vector3 directionToTarget = TargetPosition - current;
